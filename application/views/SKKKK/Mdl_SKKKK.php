<!-- Modal input data-->
<div class="modal fade" id="SKKKK" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <!-- Bagian Kiri -->
          <div class="col-md-6">
            <form action="<?php echo base_url(); ?>C_SKKKK/Upload" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input type="text" name="Id_SKKKK" class="form-control" id="Id_SKKKK" value="SDG<?= sprintf("%04s", $Id_Surat) ?>" readonly required>
                    </div>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input type="text" name="No_SKKKK" class="form-control" value="522.30 / <?= sprintf("%04s", $Id_Surat) ?> / V / SKKKK / <?= date('Y'); ?>" readonly>
                    </div>
                  </div>
                </div>
              </div>
