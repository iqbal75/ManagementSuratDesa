  ...
  <section class="content-header mt-3">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb border-left-primary shadow p-3 mb-4 bg-white rounded">
        ...
        <li class=" breadcrumb-item"><a href="<?php echo base_url(); ?>C_SKKIzajah">Keterangan Kehilangan Izajah</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <?php foreach ($skkizajah as $data) { ?>
            <form action="<?php echo base_url(); ?>C_SKKIzajah/Update" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="Id_SKKIzajah" class="col-sm-12 control-label"> <strong>Id Surat</strong></label>
                    <div class="col-sm-12">
                      <input type="text" name="Id_SKKIzajah" class="form-control" id="Id_SKKIzajah" value="<?= $data->Id_SKKIzajah ?>" readonly required>
                    </div>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="form-group">
                    <label for="No_SKKIzajah" class="col-sm-12 control-label"><strong>Nomor Surat</strong></label>
                    <div class="col-sm-12">
                      <input type="text" name="No_SKKIzajah" class="form-control" value="<?= $data->No_SKKIzajah ?>" readonly>
                    </div>
                  </div>
                </div>
              </div>
