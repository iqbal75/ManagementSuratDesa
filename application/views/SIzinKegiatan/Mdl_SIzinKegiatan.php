<!-- Modal input data-->
<div class="modal fade" id="SIzinKegiatan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <!-- Bagian Kiri -->
          <div class="col-md-6">
            <form action="<?php echo base_url(); ?>C_SIzinKegiatan/Upload" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input type="text" name="Id_SIzinKegiatan" class="form-control" id="Id_SIzinKegiatan" value="SDG<?= sprintf("%04s", $Id_Surat) ?>" readonly required>
                    </div>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input type="text" name="No_SIzinKegiatan" class="form-control" value="522.27 / <?= sprintf("%04s", $Id_Surat) ?> / V / SIK / <?= date('Y'); ?>" readonly>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="date" name="Tanggal_Pelaksanaan" class="form-control" placeholder="Tanggal_Kegiatan">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-6">
                    <label class="col-sm-12 control-label"><strong>Tempat Lahir Pengaju</strong></label>
                    <div class="col-sm-12">
                      <input type="text" name="Tempat_Lahir" class="form-control" placeholder="Tempat_Lahir">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <label class="col-sm-12 control-label"><strong>Tanggal Lahir Pengaju</strong></label>
                    <div class="col-sm-12">
