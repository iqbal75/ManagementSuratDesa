  ...
  <section class="content-header mt-3">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb border-left-primary shadow p-3 mb-4 bg-white rounded">
        ...
        <li class=" breadcrumb-item"><a href="<?php echo base_url(); ?>C_SKKip">Kehilangan KIP</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <?php foreach ($skkip as $data) { ?>
            <form action="<?php echo base_url(); ?>C_SKKip/Update" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="Id_SKKip" class="col-sm-12 control-label"> <strong>Id Surat</strong></label>
                    <div class="col-sm-12">
                      <input type="text" name="Id_SKKip" class="form-control" id="Id_SKKip" value="<?= $data->Id_SKKip ?>" readonly required>
                    </div>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input type="text" name="No_SKKip" class="form-control" value="<?= $data->No_SKKip ?>" readonly>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        <input type="text" name="Pekerjaan" class="form-control" placeholder="Pekerjaan Lengkap......" value="<?= $data->Pekerjaan ?>">
                      </div>
                    </div>
                  </div>
                </div>
