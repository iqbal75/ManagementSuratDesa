<div class="container">
  <section class="content-header mt-3">
    <h1 style="color: #fff;">Detail
      <small>Surat Rekomendasi KIP</small>
    </h1>
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb border-left-primary shadow p-3 mb-4 bg-white rounded">
        ...
        <li class=" breadcrumb-item"><a href="<?php echo base_url(); ?>C_SRKip">Rekomendasi KIP</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <?php foreach ($srkip as $data) { ?>
            <form action="<?php echo base_url(); ?>C_SRKip/Update" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="Id_SRKip" class="col-sm-12 control-label"> <strong>Id Surat</strong></label>
                    <div class="col-sm-12">
                      <input type="text" name="Id_SRKip" class="form-control" id="Id_SRKip" value="<?= $data->Id_SRKip ?>" readonly required>
                    </div>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="form-group">
                    <label for="No_SRKip" class="col-sm-12 control-label"><strong>Nomor Surat</strong></label>
                    <div class="col-sm-12">
                      <input type="text" name="No_SRKip" class="form-control" value="<?= $data->No_SRKip ?>" readonly>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-12">
              <input type="text" name="No_Kip" class="form-control" placeholder="Nomor KIP..." value="<?= $data->No_Kip ?>">
            </div>
          </div>
          <div class="form-group">
